...
const maryPrePrayers = [
  ...
  { name: 'الإيمان الرسولي', sections: [
    'أؤمن بالله الآب القدير خالق السماء والأرض. وباليسوع المسيح ابنه الوحيد ربنا. الذي حبل به من الروح القدس. ولد من مريم العذراء.',
    'تألم في أيام بيلاطس البنطي. صلب. مات ودفن. نزل إلى الجحيم في اليوم الثالث قام من بين الأموات. صعد إلى السماء.',
    '. جلس عن يمين الآب. من هناك سيأتي ليدين الأحياء والأموات. أؤمن بالروح القدس. الكنيسة المقدسة الكاثوليكية. شركة القديسين. مغفرة الخطايا. قيامة الجسد. والحياة الأبدية. آمين.'
  ] },
  { name: 'أبانا', sections: [
    'أبانا الذي في السموات. يتقدس اسمك. يأتي ملكوتك. يكن مشيئتك كما في السماء كذلك على الأرض.',
    'أعطنا خبزنا كفافنا اليومي. واغفر لنا ذنوبنا كما نغفر نحن للمذنبين إلينا. ولا تدخلنا في تجربة لكن نجنا من الشرير. آمين.'
  ] },
